            ...
            <div class="row">
                <div class="col-lg-8 col-sm-8">
                    <div class="left-content">
                        <!-- Vous pouvez ajouter du contenu spécifique à la page ici -->
                    </div>
                </div>
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="filters">
                                <ul>
                                    <!-- Vous pouvez ajuster les catégories en fonction de vos besoins -->
                        ...
                        <div class="my-5 row justify-content-around">
                            @foreach ($offres as $key => $singleOffre)
            ...
            <div class="footer">
                <p>Copyright © 2022 Edu Meeting Co., Ltd. All Rights Reserved.
                    ...
                    <br> Distributed By: <a href="https://themewagon.com" target="_blank" title="Build Better UI, Faster">ThemeWagon</a>
                </p>
            </div>
        </div>
    </section>
