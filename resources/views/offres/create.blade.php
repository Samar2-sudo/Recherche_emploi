...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Create Offre') }}</div>
                        ...
                        <form method="POST" action="{{ route('offres.store') }}">
                                ...
                                <select class="form-control @error('entreprise_associee') is-invalid @enderror"
                                    ...
                                    @foreach ($entreprises as $entreprise)
                                        <option value="{{ $entreprise->id }}"
                                            {{ old('entreprise_associee') == $entreprise->id ? 'selected' : '' }}>
                                            {{ $entreprise->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('competences') is-invalid @enderror"
                                    id="competences" name="competences" value="{{ old('competences') }}" required>
                                @error('competences')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('emplacement') is-invalid @enderror"
                                    id="emplacement" name="emplacement" value="{{ old('emplacement') }}" required>
                                @error('emplacement')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('date_de_publication') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('date_de_cloture') is-invalid @enderror"
                                    id="date_de_cloture" name="date_de_cloture" value="{{ old('date_de_cloture') }}"
                                    required>
                            ...
                            <button type="submit" class="btn btn-primary">{{ __('Create Offre') }}</button>
                        </form>
                    </div>
                </div>
            </div>
